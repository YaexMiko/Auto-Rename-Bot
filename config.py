...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "26131044")
    API_HASH  = os.environ.get("API_HASH", "a162657ddebb36315458cfb5029f11a9")
    ...
    FORCE_SUB   = os.environ.get("FORCE_SUB", "-1002019186374") 
